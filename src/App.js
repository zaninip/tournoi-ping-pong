    ...
    poules: [
      {
        ...
        matchs: [
          ...
          { joueur1: "Anthony", joueur2: "Gilles", score: "", joue: false },
          { joueur1: "Paolo", joueur2: "Gilles", score: "", joue: false }
        ]
      },
      {
        nom: "Poule Panée",
        ...
        matchs: [
          ...
          { joueur1: "David", joueur2: "Pierre-Yves", score: "", joue: false },
          { joueur1: "David", joueur2: "Riad", score: "", joue: false },
          { joueur1: "Pierre-Yves", joueur2: "Quentin", score: "", joue: false },
          { joueur1: "David", joueur2: "Quentin", score: "", joue: false },
          { joueur1: "Pierre-Yves", joueur2: "Riad", score: "", joue: false }
        ]
      },
      {
        nom: "Poule au pot",
        ...
        matchs: [
          ...
          { joueur1: "Jay", joueur2: "Yann", score: "", joue: false },
      ...
      },
      {
        ...
        matchs: [
          ...
          { joueur1: "Emilie", joueur2: "Benjamin", score: "", joue: false },
          { joueur1: "Emilie", joueur2: "Mehdi", score: "", joue: false }
        ]
      }
    ]
  };
      ...
      <main className="flex-grow p-4">
        {activeTab === 'resultats' ? (
          <div className="space-y-8">
            {tournoi.poules.map((poule, pouleIndex) => (
              <div key={pouleIndex} className="bg-white rounded-lg shadow-md overflow-hidden">
                        ...
                        <tbody className="bg-white divide-y divide-gray-200">
                          {poule.matchs.map((match, matchIndex) => {
                            ...
                            if (match.joue) {
                              ...
                              return (
                                <tr key={matchIndex}>
                                  <td className={`px-6 py-4 whitespace-nowrap ${resultat.vainqueur === 1 ? 'font-bold text-green-600' : ''}`}>{match.joueur1}</td>
                                  <td className={`px-6 py-4 whitespace-nowrap ${resultat.vainqueur === 2 ? 'font-bold text-green-600' : ''}`}>{match.joueur2}</td>
